 ...
 * TECH ADVANTAGE
 * All right reserved
 * Created by cochon on 23/04/2018.
 */
public class ContentIndexer extends ContentBase {
     ...
     * @throws IOException If an error is occurred to write the index ot to read the content.
     */
    ...
    private void indexTopics(Long strategyId, String languageCode, String strategyLabel, JsonNode rootNode) throws IOException {
    ...
    private void indexTopic(Long strategyId, String languageCode, String strategyLabel, JsonNode topicNode) throws IOException {
